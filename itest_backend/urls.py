...
from interface_app.views.project_views import ProjectView, ProjectsView
from interface_app.views.service_views import ServiceView, ServicesView
from interface_app.views.task_views import TaskTestCasesView, TasksView, TaskView, TaskRunTestCaseView, \
    TaskReportListView, TaskReportDetailView, TaskIntervalRunTestCaseView
...
urlpatterns = [
    ...
    path('backend/task/<int:task_id>/run/', TaskRunTestCaseView.as_view()),
    path('backend/task/<int:task_id>/Interval_run/', TaskIntervalRunTestCaseView.as_view()),
